...
def honey(contract):
    ...
    if response['message'] == "NOTOK":
        verified = "NO"
        print(emoji.emojize("\n:police_car_light::warning:  THIS IS POSSIBLE A HONEYPOT NO VERIFIED CONTRACT :warning: :police_car_light:",variant="emoji_type"))
        print(emoji.emojize("\n:police_car_light::warning:  NO CONNECTION WAS CREATED :warning: :police_car_light:",variant="emoji_type"))
        choose_function()
    elif response['message'] == "OK":
        verified = "YES"
        print(emoji.emojize(":check_mark_button: Contract Code Verified!",variant="emoji_type"))
        return
...
def check_honeypot_command(packet):
    global verified
    if verified == "NO":
        print(emoji.emojize("\n:police_car_light::warning:  THIS IS A HONEYPOT! NO VERIFIED CONTRACT :warning: :police_car_light:",variant="emoji_type"))
        choose_function()
    if verified == "YES":
        print(emoji.emojize("\n:check_mark_button: Contract Code Is Verified! :check_mark_button:" ,variant="emoji_type"))
        choose_function()
...
def check():
    ...
    if verified == "NO":
        ...
        choose_function()
    if verified == "YES":
        print(emoji.emojize(":check_mark_button: Contract Code Is Verified! :check_mark_button:\n" ,variant="emoji_type"))
        return
